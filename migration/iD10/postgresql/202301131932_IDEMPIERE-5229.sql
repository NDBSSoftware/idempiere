...
-- Jan 13, 2023, 9:27:29 PM CET
CREATE TABLE AD_VerifyMigration (AD_VerifyMigration_ID NUMERIC(10) NOT NULL, CONSTRAINT AD_VerifyMigration_Key PRIMARY KEY (AD_VerifyMigration_ID))
;
...
ALTER TABLE AD_VerifyMigration ADD COLUMN AD_Client_ID NUMERIC(10) NOT NULL
;
...
-- Jan 13, 2023, 9:27:30 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN AD_Org_ID NUMERIC(10) NOT NULL
;
...
-- Jan 13, 2023, 9:27:30 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN Created TIMESTAMP NOT NULL
;
...
-- Jan 13, 2023, 9:27:31 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN CreatedBy NUMERIC(10) NOT NULL
;
...
-- Jan 13, 2023, 9:27:31 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN Updated TIMESTAMP NOT NULL
;
...
-- Jan 13, 2023, 9:27:31 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN UpdatedBy NUMERIC(10) NOT NULL
;
...
-- Jan 13, 2023, 9:27:32 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
-- Jan 13, 2023, 9:27:32 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN AD_VerifyMigration_UU VARCHAR(36) DEFAULT NULL 
;
...
-- Jan 13, 2023, 9:27:33 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN Help VARCHAR(2000) DEFAULT NULL 
;
...
-- Jan 13, 2023, 9:27:33 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN AD_PInstance_ID NUMERIC(10) NOT NULL
;
...
-- Jan 13, 2023, 9:27:33 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN AD_Table_ID NUMERIC(10) NOT NULL
;
...
-- Jan 13, 2023, 9:27:34 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN Record_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Jan 13, 2023, 9:27:34 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN SeqNo NUMERIC(10) DEFAULT NULL 
;
...
-- Jan 13, 2023, 9:27:35 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN ManualNote VARCHAR(4000) DEFAULT NULL 
;
...
-- Jan 13, 2023, 9:27:35 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN ExpectedValue VARCHAR(4000) DEFAULT NULL 
;
...
-- Jan 13, 2023, 9:27:36 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN CurrentValue VARCHAR(4000) DEFAULT NULL 
;
...
-- Jan 13, 2023, 9:27:36 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN PriorityRule CHAR(1) DEFAULT NULL 
;
...
-- Jan 13, 2023, 9:27:37 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN IsIgnore CHAR(1) DEFAULT 'N' CHECK (IsIgnore IN ('Y','N')) NOT NULL
;
...
ALTER TABLE AD_VerifyMigration ADD COLUMN AD_Column_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Jan 13, 2023, 9:27:38 PM CET
ALTER TABLE AD_VerifyMigration ADD COLUMN AD_ChangeLog_ID NUMERIC(10) DEFAULT NULL 
;
