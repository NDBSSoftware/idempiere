...
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,IsHtml) VALUES (217013,0,'ISO Alpha-3 Code','ISO Alpha-3 country code - a three-letter code that represents a country name, which is usually more closely related to the country name','The official list can be found at https://www.iso.org/obp/ui/#search',170,'ISOCountryCodeAlpha3',3,'N','N','N','N','N',0,'N',10,0,0,'Y',TO_TIMESTAMP('2024-12-26 14:11:44','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2024-12-26 14:11:44','YYYY-MM-DD HH24:MI:SS'),100,203980,'Y','N','D','N','N','N','Y','264d0e73-c0b5-4dbb-9173-f8da0a7f5de5','Y',0,'N','N','N')
;

-- Dec 26, 2024, 2:11:46 PM CET
ALTER TABLE C_Country ADD ISOCountryCodeAlpha3 VARCHAR2(3 CHAR) DEFAULT NULL 
;
