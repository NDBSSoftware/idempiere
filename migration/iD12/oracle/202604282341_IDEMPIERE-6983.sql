...
BEGIN EXECUTE IMMEDIATE 'DROP INDEX ad_attachment_record'; EXCEPTION WHEN OTHERS THEN IF SQLCODE = -1418 THEN NULL; ELSE RAISE; END IF; END;
/
...
BEGIN EXECUTE IMMEDIATE 'DROP INDEX cm_chat_record'; EXCEPTION WHEN OTHERS THEN IF SQLCODE = -1418 THEN NULL; ELSE RAISE; END IF; END;
/
