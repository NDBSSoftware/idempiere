...
<p>In case of failure or timeout, the process can be launched again, it commits on every file migrated.</p>',Updated=TO_DATE('2021-04-21 17:54:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=200117
;
