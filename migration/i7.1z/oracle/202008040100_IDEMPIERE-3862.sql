...
-- Processing table AD_REF_LIST
ALTER TABLE AD_REF_LIST ADD (tmp_col_1_tmp VARCHAR2(36 CHAR),tmp_col_2_tmp VARCHAR2(255 CHAR),tmp_col_3_tmp VARCHAR2(255 CHAR),tmp_col_4_tmp VARCHAR2(60 CHAR));
ALTER TABLE AD_REF_LIST MODIFY (NAME NVARCHAR2(255) NULL,VALUE NVARCHAR2(60) NULL);
...
ALTER TABLE AD_REF_LIST MODIFY (AD_REF_LIST_UU VARCHAR2(36 CHAR),DESCRIPTION VARCHAR2(255 CHAR),NAME VARCHAR2(255 CHAR),VALUE VARCHAR2(60 CHAR));
UPDATE AD_REF_LIST SET AD_REF_LIST_UU=tmp_col_1_tmp,DESCRIPTION=tmp_col_2_tmp,NAME=tmp_col_3_tmp,VALUE=tmp_col_4_tmp;
ALTER TABLE AD_REF_LIST MODIFY (NAME VARCHAR2(255 CHAR) NOT NULL,VALUE VARCHAR2(60 CHAR) NOT NULL);
ALTER TABLE AD_REF_LIST DROP (tmp_col_1_tmp,tmp_col_2_tmp,tmp_col_3_tmp,tmp_col_4_tmp);

-- Processing table AD_REF_LIST_TRL
ALTER TABLE AD_REF_LIST_TRL ADD (tmp_col_1_tmp VARCHAR2(36 CHAR),tmp_col_2_tmp VARCHAR2(255 CHAR),tmp_col_3_tmp VARCHAR2(255 CHAR));
ALTER TABLE AD_REF_LIST_TRL MODIFY (NAME NVARCHAR2(255) NULL);
...
ALTER TABLE AD_REF_LIST_TRL MODIFY (AD_REF_LIST_TRL_UU VARCHAR2(36 CHAR),DESCRIPTION VARCHAR2(255 CHAR),NAME VARCHAR2(255 CHAR));
UPDATE AD_REF_LIST_TRL SET AD_REF_LIST_TRL_UU=tmp_col_1_tmp,DESCRIPTION=tmp_col_2_tmp,NAME=tmp_col_3_tmp;
ALTER TABLE AD_REF_LIST_TRL MODIFY (NAME VARCHAR2(255 CHAR) NOT NULL);
